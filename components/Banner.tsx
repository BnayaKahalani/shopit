...
const Banner = () => {
  ...
  function SamplePrevArrow(props: any) {
    ...
    return (
      <div
        onClick={onClick}
        className='absolute right-4 top-80 z-10 flex h-12 w-12 transform cursor-pointer items-center justify-center rounded-full border-2 border-transparent bg-gray-100 shadow-md duration-200 hover:scale-110'
      >
